...
try:
    ...
    if top_brands is None or segment_stats is None or time_conversion is None:
        print("[WARNING] Some data unavailable for visualization. Skipping visualization section.")
    else:
        # Prepare data
